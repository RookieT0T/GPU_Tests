...
// kernel code
// Access pattern: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, a, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, a
// Access count: 35
// If you have a 4MB cache with 16-way associativity, and each cache
// line is 64B with LRU replacement policy, you will observe:
// a to p will be all 16 misses, a will hit twice
// b to p will hit, q will miss and replace a, a will miss
// total 17 hits,18 misses
...
__global__ void kernel(int * arr) {
  ...
  asm volatile(
    ...
    */
    ...
    [out32]"=v"(a_1), [out34]"=v"(a_2), [out36]"=v"(b_1), [out38]"=v"(c_1), 
    ...
    [in37]"v"((uint64_t *)&arr[65537]), [in39]"v"((uint64_t *)&arr[131073]), 
