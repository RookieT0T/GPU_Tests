...
// a to p will be all misses, a will hit, a will hit, b to p will hit again, 
// q will miss by replacing b since b is least frequency used, b will then miss
  ...
  asm volatile(
    ...
    */
    ...
    asm volatile(
      ...
      [out64]"=v"(p_1), [out66]"=v"(q), [out68]"=v"(b_2)
      :
      ...
      [in65]"v"((uint64_t *)&arr[983041]), [in67]"v"((uint64_t *)&arr[1048577]), 
      [in69]"v"((uint64_t *)&arr[65538])
      :"memory"
    );
}
