...
; %bb.0:
	...
	s_addc_u32 s29, s1, 0
	s_add_u32 s30, s0, 0x80004
	s_addc_u32 s31, s1, 0
	s_add_u32 s34, s0, 0x100004
	s_addc_u32 s35, s1, 0
	s_add_u32 s36, s0, 0x440000
	s_addc_u32 s37, s1, 0
	s_add_u32 s38, s0, 0x140004
	s_addc_u32 s39, s1, 0
	s_add_u32 s40, s0, 0x200004
	s_addc_u32 s41, s1, 0
	s_add_u32 s42, s0, 0x480000
	s_addc_u32 s43, s1, 0
	s_add_u32 s44, s0, 0x4c0000
	s_addc_u32 s45, s1, 0
	s_add_u32 s46, s0, 0x40004
	s_addc_u32 s47, s1, 0
	s_add_u32 s48, s0, 8
	s_addc_u32 s49, s1, 0
	s_add_u32 s50, s0, 0xc0004
	s_addc_u32 s51, s1, 0
	s_add_u32 s52, s0, 0x100008
	s_addc_u32 s53, s1, 0
	s_add_u32 s54, s0, 0x180004
	s_addc_u32 s55, s1, 0
	s_add_u32 s56, s0, 0x500000
	s_addc_u32 s57, s1, 0
	s_add_u32 s58, s0, 0x300004
	s_addc_u32 s59, s1, 0
	s_add_u32 s60, s0, 0x340004
	s_addc_u32 s61, s1, 0
	s_add_u32 s62, s0, 0x380004
	s_addc_u32 s63, s1, 0
	s_add_u32 s64, s0, 0x3c0004
	s_addc_u32 s65, s1, 0
	s_add_u32 s66, s0, 0x540000
	s_addc_u32 s67, s1, 0
	s_add_u32 s68, s0, 0x40008
	s_addc_u32 s69, s1, 0
	s_add_u32 s70, s0, 0x580000
	s_addc_u32 s71, s1, 0
	s_add_u32 s72, s0, 12
	s_addc_u32 s73, s1, 0
	s_add_u32 s74, s0, 0x300008
	s_addc_u32 s75, s1, 0
	s_add_u32 s76, s0, 0x5c0000
	s_addc_u32 s77, s1, 0
	s_add_u32 s78, s0, 0x140008
	s_addc_u32 s79, s1, 0
	s_add_u32 s80, s0, 0x10000c
	s_addc_u32 s81, s1, 0
	s_add_u32 s82, s0, 0x200008
	s_addc_u32 s83, s1, 0
	s_add_u32 s84, s0, 0x4000c
	s_addc_u32 s85, s1, 0
	s_add_u32 s86, s0, 0x380008
	s_addc_u32 s87, s1, 0
	s_add_u32 s88, s0, 0x500004
	s_addc_u32 s89, s1, 0
	s_add_u32 s90, s0, 0x80008
	s_addc_u32 s91, s1, 0
	s_add_u32 s92, s0, 0x340008
	s_addc_u32 s93, s1, 0
	v_mov_b32_e32 v0, s0
	v_mov_b32_e32 v1, s1
	s_add_u32 s0, s0, 0xc0008
	s_addc_u32 s1, s1, 0
	v_mov_b32_e32 v9, s5
	...
	v_mov_b32_e32 v71, s67
	v_mov_b32_e32 v73, s69
	v_mov_b32_e32 v75, s71
	v_mov_b32_e32 v77, s73
	v_mov_b32_e32 v79, s75
	v_mov_b32_e32 v81, s77
	v_mov_b32_e32 v83, s79
	v_mov_b32_e32 v85, s81
	v_mov_b32_e32 v87, s83
	v_mov_b32_e32 v89, s85
	v_mov_b32_e32 v91, s87
	v_mov_b32_e32 v93, s89
	v_mov_b32_e32 v95, s91
	v_mov_b32_e32 v97, s93
	...
	v_mov_b32_e32 v72, s68
	v_mov_b32_e32 v74, s70
	v_mov_b32_e32 v76, s72
	v_mov_b32_e32 v78, s74
	v_mov_b32_e32 v80, s76
	v_mov_b32_e32 v82, s78
	v_mov_b32_e32 v84, s80
	v_mov_b32_e32 v86, s82
	v_mov_b32_e32 v88, s84
	v_mov_b32_e32 v90, s86
	v_mov_b32_e32 v92, s88
	v_mov_b32_e32 v94, s90
	v_mov_b32_e32 v96, s92
	...
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[70:71], v[70:71] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[72:73], v[72:73] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[74:75], v[74:75] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[76:77], v[76:77] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[78:79], v[78:79] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[80:81], v[80:81] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[82:83], v[82:83] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[84:85], v[84:85] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[86:87], v[86:87] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[88:89], v[88:89] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[90:91], v[90:91] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[92:93], v[92:93] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[94:95], v[94:95] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[96:97], v[96:97] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	flat_load_dwordx2 v[98:99], v[98:99] glc
	s_waitcnt vmcnt(0) & lgkmcnt(0)
	s_nop 0
