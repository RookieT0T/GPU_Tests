...
; %bb.0:
	...
	s_add_u32 s28, s0, 8
	s_addc_u32 s29, s1, 0
	s_add_u32 s30, s0, 0x40004
	s_addc_u32 s31, s1, 0
	s_add_u32 s34, s0, 0x40008
	s_addc_u32 s35, s1, 0
	s_add_u32 s36, s0, 0x80004
	s_addc_u32 s37, s1, 0
	s_add_u32 s38, s0, 0xc0004
	s_addc_u32 s39, s1, 0
	s_add_u32 s40, s0, 0x100004
	s_addc_u32 s41, s1, 0
	s_add_u32 s42, s0, 0x140004
	s_addc_u32 s43, s1, 0
	s_add_u32 s44, s0, 0x180004
	s_addc_u32 s45, s1, 0
	s_add_u32 s46, s0, 0x1c0004
	s_addc_u32 s47, s1, 0
	s_add_u32 s48, s0, 0x200004
	s_addc_u32 s49, s1, 0
	s_add_u32 s50, s0, 0x240004
	s_addc_u32 s51, s1, 0
	s_add_u32 s52, s0, 0x280004
	s_addc_u32 s53, s1, 0
	s_add_u32 s54, s0, 0x2c0004
	s_addc_u32 s55, s1, 0
	s_add_u32 s56, s0, 0x300004
	s_addc_u32 s57, s1, 0
	s_add_u32 s58, s0, 0x340004
	s_addc_u32 s59, s1, 0
	s_add_u32 s60, s0, 0x380004
	s_addc_u32 s61, s1, 0
	s_add_u32 s62, s0, 0x3c0004
	s_addc_u32 s63, s1, 0
	s_add_u32 s64, s0, 0x400000
	s_addc_u32 s65, s1, 0
	s_add_u32 s66, s0, 12
	s_addc_u32 s67, s1, 0
	v_mov_b32_e32 v0, s0
	v_mov_b32_e32 v1, s1
	s_add_u32 s0, s0, 0x4000c
	s_addc_u32 s1, s1, 0
	v_mov_b32_e32 v9, s5
