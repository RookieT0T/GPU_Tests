...
// a to p will miss and q miss, r miss, b hit
...
__global__ void kernel(int * arr) {
  ...
  uint64_t a = 0, b = 0, c = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = 0, n = 0, o = 0, p = 0, q = 0, r = 0;
  uint64_t b_2 = 0;
  asm volatile(
    /*
    ...
    */
    ...
    [out32]"=v"(q), [out34]"=v"(r), [out36]"=v"(b_2)
    ...
    [in33]"v"((uint64_t *)&arr[1048576]), [in35]"v"((uint64_t *)&arr[1114112]), 
