...
// line is 64B with LIP replacement policy, you will observe:
// a to p will miss, a will hit, and q will replace b and miss, a will hit
// total 2 hit, 17 misses
...
__global__ void kernel(int * arr) {
  ...
  asm volatile(
    ...
    */
    ...
    [out32]"=v"(a1), [out34]"=v"(q), [out36]"=v"(a2)
    ...
    [in33]"v"((uint64_t *)&arr[1]), [in35]"v"((uint64_t *)&arr[1048576]),
    [in37]"v"((uint64_t *)&arr[2])
