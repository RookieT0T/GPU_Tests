...
// kernel code
// Access pattern: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, b, a, q, i
// Access count: 20
// If you have a 4MB cache with 16-way associativity, and each cache
// line is 64B with treePLRU replacement policy, you will observe:
// a to p misses, b hit, a hit, q miss and replace i, i miss
// total 18 misses, 2 hit
...
__global__ void kernel(int * arr) {
  ...
  uint64_t b_1 = 0, a_1 = 0, q = 0, i_1 = 0;
  asm volatile(
    /*
    ...
    */
    ...
    [out32]"=v"(b_1), [out34]"=v"(a_1), [out36]"=v"(q), [out38]"=v"(i_1)
    ...
    [in33]"v"((uint64_t *)&arr[65537]), [in35]"v"((uint64_t *)&arr[1]), 
    [in37]"v"((uint64_t *)&arr[1048576]), [in39]"v"((uint64_t *)&arr[524289])
    :"memory"
