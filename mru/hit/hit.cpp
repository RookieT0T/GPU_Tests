...
// kernel code
// Access pattern: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, p
// Access count: 18
// If you have a 4MB cache with 16-way associativity, and each cache
// line is 64B with MRU replacement policy, you will observe:
// a to p will miss, q will miss and replace p, and p will miss
// total 18 misses
...
__global__ void kernel(int * arr) {
  ...
  asm volatile(
    ...
    */
    ...
    [in33]"v"((uint64_t *)&arr[1048576]), [in35]"v"((uint64_t *)&arr[983041])
