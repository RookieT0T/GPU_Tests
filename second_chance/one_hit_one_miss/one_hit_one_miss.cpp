...
// kernel code
// Access pattern: a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, a, b, a, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, a
// Access count: 35
// If you have a 4MB cache with 16-way associativity, and each cache
// line is 64B with Second Chance replacement policy, you will observe:
// a to p will have misses, a hit, b hit, a hit, c to d will hit and q miss and replace a, a miss
// total 17 hit, 18 misses
...
__global__ void kernel(int * arr) {
  ...
  asm volatile(
    ...
    */
    ...
    [out32]"=v"(a_1), [out34]"=v"(b_1), [out36]"=v"(a_2), [out38]"=v"(c_1), 
    [out40]"=v"(d_1), [out42]"=v"(e_1), [out44]"=v"(f_1), [out46]"=v"(g_1), 
    [out48]"=v"(h_1), [out50]"=v"(i_1), [out52]"=v"(j_1), [out54]"=v"(k_1),
    [out56]"=v"(l_1), [out58]"=v"(m_1), [out60]"=v"(n_1), [out62]"=v"(o_1), 
    [out64]"=v"(p_1), [out66]"=v"(q), [out68]"=v"(a_3)
    ...
    [in33]"v"((uint64_t *)&arr[1]), [in35]"v"((uint64_t *)&arr[65537]),
    [in37]"v"((uint64_t *)&arr[2]), [in39]"v"((uint64_t *)&arr[131073]), 
    [in41]"v"((uint64_t *)&arr[196609]), [in43]"v"((uint64_t *)&arr[262145]), 
    [in45]"v"((uint64_t *)&arr[327681]), [in47]"v"((uint64_t *)&arr[393217]), 
    [in49]"v"((uint64_t *)&arr[458753]), [in51]"v"((uint64_t *)&arr[524289]), 
    [in53]"v"((uint64_t *)&arr[589825]), [in55]"v"((uint64_t *)&arr[655361]),
    [in57]"v"((uint64_t *)&arr[720897]), [in59]"v"((uint64_t *)&arr[786433]), 
    [in61]"v"((uint64_t *)&arr[851969]), [in63]"v"((uint64_t *)&arr[917505]),
    [in65]"v"((uint64_t *)&arr[983041]), [in67]"v"((uint64_t *)&arr[1048576]), 
    [in69]"v"((uint64_t *)&arr[3])
