...
// line is 64B with NRU replacement policy, you will observe:
// a to p will miss, a will hit, and q will miss, a will miss
// total 1 hit, 18 misses
...
__global__ void kernel(int * arr) {
  ...
  asm volatile(
    ...
    */
    ...
    [out32]"=v"(a_1), [out34]"=v"(q), [out36]"=v"(a_2)
